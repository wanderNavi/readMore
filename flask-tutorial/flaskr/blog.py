...
# could technically find a way to get create and update template packaged together into one method but separate is clearer
...
# argument id corresponds to <int:id> in route (classified as int not string)
